...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_PN_D_HERE, &op_P_D_RND, &op_PN_D_RND, &op_P_D_RND_M, &op_PN_D_RND_M,
    &op_P_D_RND_N, &op_PN_D_RND_N, &op_P_STEP, &op_PN_STEP, &op_P_STEP_NEW,
    &op_PN_STEP_NEW, &op_P_STEPQ, &op_PN_STEPQ, &op_P_MODE, &op_PN_MODE,
    &op_P_DIR, &op_PN_DIR, &op_P_STRIDE, &op_PN_STRIDE, &op_P_MOTIF,
    &op_PN_MOTIF, &op_P_CP, &op_PN_CP, &op_P_FUGUE, &op_PN_FUGUE, &op_P_ORN,
    &op_PN_ORN,
    ...
    &op_RRND, &op_SRND, &op_SRND_R, &op_R, &op_R_MIN, &op_R_MAX, &op_TOSS,
    &op_MIN, &op_MAX, &op_LIM, &op_WRAP, &op_WRP, &op_QT, &op_QT_S, &op_QT_CS,
    &op_QT_B, &op_QT_BX, &op_AVG, &op_EQ, &op_NE, &op_LT, &op_GT, &op_LTE,
    &op_GTE, &op_INR, &op_OUTR, &op_INRI, &op_OUTRI, &op_NZ, &op_EZ, &op_RSH,
    &op_LSH, &op_LROT, &op_RROT, &op_EXP, &op_ABS, &op_SGN, &op_AND, &op_OR,
    &op_AND3, &op_OR3, &op_AND4, &op_OR4, &op_JI, &op_SCALE, &op_SCL,
    &op_SCALE0, &op_SCL0, &op_N, &op_VN, &op_HZ, &op_N_S, &op_N_C, &op_N_CS,
    &op_N_B, &op_N_BX, &op_V, &op_VV, &op_ER, &op_NR, &op_DR_T, &op_DR_P,
    &op_DR_V, &op_CA, &op_CA_X, &op_CA_SEED, &op_POLY, &op_POLY_X, &op_POLY_A,
    &op_ERD, &op_ERD_W, &op_BB, &op_BPM, &op_BIT_OR, &op_BIT_AND, &op_BIT_NOT,
    &op_BIT_XOR, &op_BSET, &op_BGET, &op_BCLR, &op_BTOG, &op_BREV, &op_XOR,
