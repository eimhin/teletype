...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_N_CS, &op_N_B, &op_N_BX, &op_VN_B, &op_V, &op_VV, &op_ER, &op_NR,
    &op_DR_T, &op_DR_P, &op_DR_V, &op_CA, &op_CA_X, &op_CA_SEED, &op_POLY,
    &op_POLY_X, &op_POLY_A, &op_ERD, &op_ERD_W, &op_BB, &op_BPM, &op_BIT_OR,
